            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    <div class="row">
                        <div class="col-md-5">
                            <div class="block">
                                <form role="form" id="Crear_Cliente_Queue" action="../action/Procesos_Queue.php" method="POST">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <select name="Segmento" id="Segmento" class="control-select select">
                        ...
                        <div class="col-md-5">
                            <div class="form-horizontal">
                                <div class="block">
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Tasa Descarga</label>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control Kbytes" name="Download" id="Download">
                                        </div>
                                    </div>
                                    <div class="form-group">
