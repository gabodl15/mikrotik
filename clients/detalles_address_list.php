        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Listado Address List</h2>
                </div>
                <!-- END PAGE TITLE -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Total Lista</h3>
                                         ...
                                         <?php
                                            ...
                                            if(count($ARRAY)>0){   // si hay mas de 1 queue.
                                                for($x=0;$x<count($ARRAY);$x++){
                                                    ...
                                                    $detalles_addresss_list = '<tr>';
                                                    $detalles_addresss_list.= '<td>'.$ARRAY[$x]['address'].'</td>';
                                                    $detalles_addresss_list.= '<td>'.$ARRAY[$x]['list'].'</td>';
                                                    $detalles_addresss_list.= '<td>'.$tipo_list.'</td>';
                                                    $detalles_addresss_list.= '<td>'.$comentarios.'</td>';
                                                    $detalles_addresss_list.= '</tr>';
                                                    echo $detalles_addresss_list;
                                                }
